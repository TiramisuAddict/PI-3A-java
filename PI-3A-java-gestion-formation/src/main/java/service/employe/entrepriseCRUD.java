...
import service.employe.generationMotDePasse;
import utils.MyDB;
...
public class entrepriseCRUD implements service.InterfaceCRUD<entreprise> {
    ...
    public void accepterEntreprise(entreprise e) throws SQLException {
        ...
        try {
            ...
            try (PreparedStatement ps2 = conn.prepareStatement(sqlEmploye, Statement.RETURN_GENERATED_KEYS)) {
                ...
                ps2.setString(5, "CEO");
                ps2.setString(6, "administrateur entreprise");
