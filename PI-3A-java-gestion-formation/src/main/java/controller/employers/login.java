...
import models.employe.administrateur_systeme;
...
public class login {
        ...
        try {
            ...
            if (compteConnecte != null && compteConnecte.getPassword().equals(password)) {
                ...
                if (emp != null) {
                    ...
                    if (r.equals("administrateur entreprise") || r.equals("rh")) {
    ...
    private void openRHetAdminInterface() {
        try {
            // Afficher d'abord la page de bienvenue
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/welcome.fxml"));
            Parent root = loader.load();

            Stage stage = new Stage();
            stage.setTitle("Momentum - Bienvenue");
            stage.setScene(new Scene(root));
            stage.show();
            ...
            e.printStackTrace();
            errorLabel.setText("Erreur lors de l'ouverture de la page de bienvenue.");
        }
    }
    ...
    private void openInterfaceEmployeSimple() {
        try {
            ...
            e.printStackTrace();
            errorLabel.setText("Erreur ouverture interface de bienvenue.");
        }
    }
}